...
public class AttendanceController {
    ...
    public ResponseEntity<AttendanceResponse> markAttendance(
        ...
        return ResponseEntity.ok(attendanceService.markAttendance(activityId, request, currentUser));
    }
    ...
    public ResponseEntity<List<AttendanceResponse>> syncOffline(
        ...
        return ResponseEntity.ok(attendanceService.syncOfflineAttendance(request, currentUser));
    }
    ...
    public ResponseEntity<List<AttendanceResponse>> getAttendance(
            @PathVariable UUID activityId) {
        return ResponseEntity.ok(attendanceService.getAttendanceForActivity(activityId));
    }
    ...
    public ResponseEntity<List<AttendanceResponse>> getAbsentMembers(
            @PathVariable UUID activityId) {
        return ResponseEntity.ok(attendanceService.getAbsentMembers(activityId));
    }
}